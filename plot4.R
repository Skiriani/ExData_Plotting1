#Creating Plot 4 for Week 1 of Exploratory data analysis assignment
...
with(dat2,{
        ...
        legend("topright",c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), col=c("black","red","blue"), lty=1, cex = 0.50)
